...
<title>Online Quiz by Rahul Sharma</title>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by MMMUT GORAKHPUR</a>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Rahul Sharma-MCA(MMMUT GKP)</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7905341203</h4>
		<h4 style="font-family:'typo' ">zwtyrrs@gmail.com</h4>
		<h4 style="font-family:'typo' ">Madan Mohan Malaviya University of Technology,Gorakhpur
</h4></div></div>
		</p>
      </div>
